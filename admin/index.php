...
session_start();
 ...
 if(!isset($_SESSION['email'])){
  ...
  $get_adim= "select * from admins where admin_email='$admin_session'";
  $run_admin = mysqli_query($con,$get_adim);
    ...
    <ul class="navbar-nav ">
      ...
      <li class="nav-item dropdown ">
        <a class="nav-link mg-1" data-toggle="dropdown" href="#" >
          <i class="fas fa-user-tie"></i> <?php echo $admin_name; ?> <b class="caret"></b>
    ...
    <div class="conatiner"><!-- conatiner-fluid begin -->
       <?php
           if(isset($_GET['dashboard'])){
             ...
             include("doctor_specialization.php");

           }if(isset($_GET['add_doctor'])){
             include("insert_doctor.php");
           }

           if(isset($_GET['manage_doctor'])){
           ...
           if(isset($_GET['edit_specialization'])){
            ...
            include("edit_specialization.php");
          }
          ...
          if(isset($_GET['doctor_log'])){
            include("doctor_log.php");
